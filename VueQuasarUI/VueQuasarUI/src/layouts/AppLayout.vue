          ...
          <template v-for="menu in menus">
            ...
            <template v-for="child1 in menu.child">
              ...
              <q-expansion-item
                ...
                v-else-if="child1.child.length > 0"
              >
                <!--child-->
                <template v-for="child2 in child1.child">
                  ...
                  <q-expansion-item
                    ...
                    v-if="child2.child.length > 0"
                  >
                    <template v-for="child3 in child2.child">
                      <q-item
                        clickable
                        v-ripple
                        :to="{ name: child3.url }"
                        v-if="child3.child.length == 0"
                      >
                        <q-item-section avatar>
                          <q-icon :name="child3.icon" />
                        </q-item-section>
                        <q-item-section style="font-size:"> {{ child3.title }}</q-item-section>
                        <!-- write here if you need subchild again -->
                      </q-item>
                    </template>
                  </q-expansion-item>
                </template>
